...
import {
  LOT_ET_GARONNE_FAQ,
  LOT_ET_GARONNE_PRIORITY_SECTORS,
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:items-center">
            <div>
              ...
              <div className="space-y-5 text-textLight leading-comfortable">
                <p>
                  Etoilys intervient dans le Lot-et-Garonne, notamment autour d’Agen,
                  Villeneuve-sur-Lot, Marmande, Casteljaloux, Lauzun, Castillonès, Villeréal,
                  Cancon, Damazan et des secteurs proches.
                </p>
                <p>
                  Vous pouvez déposer une demande même si votre commune n’apparaît pas dans cette
                  liste : Etoilys vous confirmera les modalités d’intervention après réception de
                  votre demande.
                </p>
                <Link
            ...
            <Card hover={false} className="p-6 md:p-8">
              ...
              <div className="flex flex-wrap gap-3">
                {LOT_ET_GARONNE_PRIORITY_SECTORS.map((sector) => (
                  <span
                    key={sector}
