...
export default function ClassementGironde() {
  const departmentArea = getDepartmentInterventionArea('gironde');
          ...
          <div className="mx-auto max-w-6xl">
            <div className="max-w-4xl">
              ...
              <p className="text-textLight leading-comfortable">
                ...
                Haute-Gironde, de Bordeaux Métropole, de l’Entre-deux-Mers, de Montesquieu, de la
                vallée de la Garonne et du nord du Sud-Gironde.
              </p>
            </div>

            <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
              {GIRONDE_SERVICE_SECTORS.map((sector) => (
