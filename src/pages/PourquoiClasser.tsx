...
const mainBenefits = [
  {
    ...
    description:
      'Un meublé classé génère en moyenne 15 à 25% de revenus supplémentaires grâce à une meilleure visibilité et des tarifs justifiés.',
  },
  {
    icon: Users,
    title: 'Confiance accrue',
    description:
      'Les voyageurs privilégient les hébergements classés qui garantissent un niveau de qualité et de confort vérifié.',
  },
  {
    icon: Award,
    title: 'Reconnaissance officielle',
    description:
      "Le classement est délivré par un organisme accrédité et reconnu par l'État, valorisant votre professionnalisme.",
  },
  {
    icon: Calculator,
  ...
  },
  {
    ...
    description:
      'Les plateformes de réservation mettent en avant les hébergements classés dans leurs résultats de recherche.',
  },
  {
    icon: Shield,
    title: 'Protection juridique',
    description:
      'Le classement facilite vos démarches administratives et vous protège en cas de litige avec les locataires.',
  },
];
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 bg-success-100 border border-success-200 rounded-card p-6">
              <p className="text-center text-gray-800 font-medium">
                <span className="text-success-400 font-bold">Abattement majoré :</span> sur 12 000 €
                de recettes annuelles, la base micro-BIC imposable est de 6 000 € avec classement
                (50 %) contre 8 400 € sans classement (30 %).
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4 text-textLight leading-comfortable">
                <p>
                  Les études menées sur le marché de la location saisonnière démontrent que les
                  hébergements classés bénéficient d'un taux d'occupation supérieur de 20 à 30% par
                  rapport aux logements non classés.
                </p>
                <p>
                  Cette meilleure performance s'explique par la confiance que le classement inspire
                  aux voyageurs et par la mise en avant des hébergements certifiés sur les
                  plateformes de réservation.
                </p>
                <p>
                  De plus, le classement vous permet de justifier des tarifs plus élevés, reflétant
                  la qualité et le confort de votre hébergement. L'investissement dans le classement
        ...
        <div className="container-adaptive">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-textLight mb-8 leading-comfortable">
              Le coût du classement est rapidement compensé par l'augmentation de vos revenus et les
              économies fiscales réalisées. C'est un investissement intelligent pour valoriser votre
              patrimoine et optimiser votre activité de location saisonnière.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-white p-6 rounded-card">
                ...
                <p className="text-sm text-textLight">d'abattement micro-BIC (meublé classé)</p>
              </div>
              <div className="bg-white p-6 rounded-card">
