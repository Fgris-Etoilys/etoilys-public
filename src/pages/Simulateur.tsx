        ...
        <div className="container-adaptive">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 leading-comfortable">
              Estimez le niveau de classement potentiel de votre meublé et calculez vos économies
              fiscales.
            </p>
          </div>
        </div>
        ...
        <div className="container-adaptive">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-textLight mb-12 leading-comfortable">
              Nous travaillons actuellement sur un simulateur interactif qui vous permettra de
              calculer vos économies grâce au classement de votre meublé de tourisme.
            </p>
            <div className="bg-primary-100 rounded-card p-8 mb-12">
              ...
              <ul className="text-left space-y-3 text-textLight max-w-2xl mx-auto">
                <li className="flex gap-3">
                  ...
                  <span>
                    Estimer le niveau de classement potentiel (1 à 5 étoiles) de votre hébergement
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary-300 font-bold">✓</span>
                  <span>
                    Calculer votre base imposable micro-BIC selon le classement (abattement 50 %
                    classé / 30 % non classé)
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary-300 font-bold">✓</span>
                ...
                <li className="flex gap-3">
                  <span className="text-primary-300 font-bold">✓</span>
                  <span>
                    Identifier les améliorations à apporter pour obtenir un classement supérieur
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary-300 font-bold">✓</span>
            ...
            <div className="bg-accent-1 rounded-card p-8">
              ...
              <p className="text-textLight mb-6 leading-comfortable">
                Notre équipe d'experts est disponible pour étudier votre situation et vous fournir
                une estimation personnalisée de votre classement potentiel et des économies
                réalisables.
              </p>
