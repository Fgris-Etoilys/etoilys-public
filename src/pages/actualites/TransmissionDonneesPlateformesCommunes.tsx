  ...
  return (
      ...
      lede={
        <>
          <p className="text-xl leading-comfortable text-gray-700 mb-10">
            Depuis 2026, les communes disposent d&apos;un nouvel outil pour contrôler les meublés de
            tourisme loués via des plateformes comme Airbnb, Booking ou Abritel :{' '}
        ...
        <>
          <div className="mt-12 mb-12 p-8 bg-primary-100 rounded-card border border-primary-200">
            ...
            <p className="text-gray-700 mb-6">
              Retrouvez les principales démarches dans la FAQ et comparez, séparément, la fiscalité
              d&apos;un meublé classé ou non classé.
            </p>
    ...
    >
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        parfois des informations différentes. Pour connaître l&apos;activité d&apos;un logement, une
        commune devait auparavant demander des informations séparément à chaque intermédiaire.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
        La Direction générale des Entreprises présente l&apos;API Meublés comme un{' '}
        <strong>guichet unique de centralisation des données d&apos;activité</strong> transmises par
        les intermédiaires de location. La commune ou l&apos;intercommunalité inscrite peut ainsi
        accéder, depuis un même outil, aux données demandées pour son territoire.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-card p-5 mb-6">
        <p className="text-gray-700 leading-comfortable">
          L&apos;accès n&apos;est pas automatique partout. Une commune ou une intercommunalité doit
          s&apos;inscrire dans l&apos;API Meublés et demander explicitement les données
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        vise les grandes plateformes de réservation, comme Airbnb, Booking et Abritel, mais aussi
        tout acteur entrant dans ce rôle d&apos;intermédiaire.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
        Chaque intermédiaire transmet les données relatives aux locations réalisées par son propre
        service. L&apos;API permet ensuite à la collectivité de rapprocher les informations
        plateforme par plateforme autour du même numéro d&apos;enregistrement. Une activité répartie
        entre plusieurs sites devient donc plus simple à reconstituer.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
        Une réservation conclue directement par le propriétaire, sans intermédiaire, ne constitue
        pas une donnée transmise par Airbnb, Booking ou Abritel. Elle reste toutefois soumise aux
        obligations applicables au logement. Le code du tourisme permet notamment à la commune de
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        d&apos;enregistrement, les URL des annonces publiées en ligne, l&apos;adresse précise du
        meublé et le nombre de jours loués par l&apos;intermédiaire pendant la période concernée.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
        D&apos;autres informations sont transmises lorsque l&apos;intermédiaire en a connaissance :
        identité et coordonnées du loueur, SIRET, statut de résidence principale, caractère
        professionnel de l&apos;activité ou encore total annuel des jours loués par cet
        intermédiaire.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        Les données obligatoires transmises par les plateformes portent sur l&apos;identification du
        meublé, ses annonces et son activité en nombre de jours, pas sur le montant des loyers
        encaissés ni sur le détail des paiements des voyageurs.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
        L&apos;API Meublés n&apos;est pas non plus le système de collecte ou de suivi de la taxe de
        séjour. La DGE la distingue expressément de <strong>FARITAS</strong>, le dispositif
        expérimental de télédéclaration de la taxe de séjour collectée par les opérateurs
        numériques, prévu jusqu&apos;à la fin de l&apos;année 2026.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
        Les plateformes peuvent transmettre des informations fiscales à l&apos;administration
        fiscale dans le cadre d&apos;autres règles. Cette transmission est distincte de l&apos;accès
        accordé aux communes et intercommunalités par l&apos;API Meublés.
      </p>
      <div className="bg-gray-50 border border-gray-200 rounded-card p-5 mb-6">
        <p className="text-gray-700 leading-comfortable">
          ...
          n&apos;est pas l&apos;outil qui calcule votre impôt, ni celui qui suit le paiement de
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        collectivités déjà habilitées, a été déployée à partir de mars 2026. La DGE annonce la
        version finale pour le <strong>second semestre 2026</strong>, sans fixer à ce stade de date
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        référencements. La transmission intervient au plus tard un mois après la fin de la période
        concernée.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
        Dans la version finale, les loueurs devront demander un nouveau numéro d&apos;enregistrement
        national pour chaque meublé de tourisme via le téléservice national. Les anciens numéros
        locaux resteront utilisables pendant une période transitoire, puis deviendront invalides.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
        Cette transition concerne l&apos;enregistrement des logements. Pour un décryptage centré sur
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        de location d&apos;une résidence principale existaient déjà. Le changement porte surtout sur
        la capacité à rapprocher les données.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
        Avant, une commune devait souvent demander des informations plateforme par plateforme. Avec
        l&apos;API Meublés, les données d&apos;activité sont centralisées autour du numéro
        d&apos;enregistrement. Cela rend plus visibles les annonces sans numéro là où il est
        obligatoire, les faux numéros, les anciens numéros devenus invalides, les adresses
        incohérentes ou les dépassements de durée pour les résidences principales.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
        La commune peut comparer le numéro, l&apos;adresse, les URL d&apos;annonces, le statut de
        résidence principale lorsqu&apos;il est connu et le nombre de jours déclaré par chaque
        plateforme. Répartir les réservations entre plusieurs intermédiaires ne rend donc plus aussi
        difficile la reconstitution du total d&apos;activité.
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
        Le code prévoit également que la collectivité soit informée lorsqu&apos;un logement déclaré
        comme résidence principale dépasse 120 jours de location, ou le plafond local abaissé entre
        90 et 119 jours. Les données présentes dans l&apos;API peuvent être utilisées par les
      ...
      <p className="text-gray-700 leading-comfortable mb-6">
        ...
        écarts avant qu&apos;ils ne ressortent lors d&apos;un contrôle :
      </p>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-card p-5 mb-10">
        <p className="text-gray-700 leading-comfortable">
          Le changement n&apos;est pas que les plateformes transmettent « plus de données pour le
          plaisir ». Le vrai changement, c&apos;est que les communes disposent d&apos;un outil plus
          simple pour rapprocher les annonces, les numéros d&apos;enregistrement, les adresses et
          les jours loués. Pour un propriétaire, les points essentiels sont donc la cohérence de ses
          annonces, le suivi de ses jours de location et la vérification des obligations locales.
        </p>
      </div>
    </ArticleLayout>
  );
