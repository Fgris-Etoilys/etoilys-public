...
export default function ArticleCoproprieteLocationTouristique() {
  return (
    ...
    >
      ...
      <p className="text-muted leading-comfortable mb-4">En pratique, c'est plus nuancé.</p>
      <p className="text-muted leading-comfortable mb-4">
        Oui, la{' '}
        <a
      ...
      <p className="text-muted leading-comfortable mb-4">Le bon réflexe est de distinguer :</p>
      ...
      <blockquote className="article-quote my-4 italic">
        Ma copropriété peut-elle interdire Airbnb ?
      </blockquote>
      <p className="text-muted leading-comfortable mb-4">La vraie question est plutôt :</p>
