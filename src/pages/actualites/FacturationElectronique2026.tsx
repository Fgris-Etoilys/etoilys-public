    ...
    >
      ...
      <ul className="space-y-2 mb-6 text-gray-700">
        ...
        <li className="flex gap-3">
          ...
          <span>
            <strong>oui</strong>, vous êtes déjà concerné par la réforme si vous exploitez votre
            activité avec un <strong>SIREN</strong>, ne serait-ce que pour la{' '}
      ...
      <ul className="space-y-2 mb-6 text-gray-700">
        ...
        <li className="flex gap-3">
          ...
          <span>
            l'<strong>émission</strong> selon le calendrier de votre catégorie d'entreprise&nbsp;;
          </span>
        </li>
        <li className="flex gap-3">
          <span className="text-primary-400 font-bold shrink-0 mt-0.5" aria-hidden="true">
          ...
          <span>
            et, selon les opérations réalisées, les obligations de <strong>e-reporting</strong> ou
            de <strong>transmission des données de paiement</strong>.
          </span>
        </li>
      </ul>
      ...
      <ul className="space-y-3 mb-6 text-gray-700">
        <li className="flex gap-3">
          ...
          <span>
            ...
            montant passe à <strong>1&nbsp;000&nbsp;€</strong> après chaque nouvelle période de
            trois mois.
          </span>
        </li>
        <li className="flex gap-3">
          ...
          <span>
            En cas de non-dépôt d'une facture sous <strong>format électronique</strong> lorsqu'elle
            devait l'être, une <strong>amende de 15&nbsp;€ par facture</strong> est prévue,
            plafonnée à <strong>15&nbsp;000&nbsp;€ par année civile</strong>
