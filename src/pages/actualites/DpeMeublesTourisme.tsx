    ...
    >
      ...
      <ul className="space-y-2 mb-6 text-gray-700">
        ...
        <li className="flex gap-3">
          ...
          <span>
            ...
            <strong>1er janvier 2034</strong> pour les meublés de tourisme qui ne constituent pas la
      ...
      <ul className="space-y-2 mb-6 text-gray-700">
        <li className="flex gap-3">
          ...
          <span>
            une résidence secondaire transformée en location touristique régulière dans une commune
            qui applique cette procédure ;
          </span>
        </li>
        <li className="flex gap-3">
          <span className="text-primary-400 font-bold shrink-0 mt-0.5" aria-hidden="true">
        ...
        <li className="flex gap-3">
          ...
          <span>
            un appartement situé dans une zone où la commune encadre fortement la transformation de
            logements d&apos;habitation en meublés touristiques.
          </span>
        </li>
      </ul>
      <p className="text-gray-700 leading-comfortable mb-4">
      ...
      <ul className="space-y-2 mb-6 text-gray-700">
        ...
        <li className="flex gap-3">
          ...
          <span>
            si le règlement de copropriété contient des restrictions, lorsque le logement est en
            copropriété.
          </span>
        </li>
      </ul>
