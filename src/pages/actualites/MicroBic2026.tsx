  ...
  return (
      ...
      lede={
        <>
          ...
          <p className="text-xl leading-comfortable text-gray-700 mb-10">
            ...
            rupture s'applique déjà à la <strong>déclaration 2026 sur les revenus 2025</strong>. Il
            faut aussi éviter de confondre micro-BIC, micro-entreprise et régime réel.
          </p>
        </>
      }
      keyTakeaways={
    ...
    >
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        n'a pas supprimé l'intérêt fiscal du classement. Elle l'a au contraire rendu plus visible,
        parce qu'elle a fortement durci la situation des meublés non classés. Et la grande rupture
        s'applique déjà à la déclaration 2026 sur les revenus 2025, pas seulement à des horizons
        futurs.
      </p>
      ...
      <p className="text-gray-700 leading-comfortable mb-6">
        ...
        , les seuils et abattements du micro-BIC ne sont plus du tout les mêmes selon que le meublé
        est classé ou non. Le tableau suivant résume les paramètres en vigueur, tels que confirmés
        par la{' '}
        <a
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        revenus 2026 déclarés en 2027 : le plafond des meublés classés passe à 83 600 €, tandis que
        celui des meublés non classés reste fixé à 15 000 €. Ces paramètres sont également confirmés
        par la{' '}
        <a
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        >
          notre article dédié explique comment séparer les catégories de recettes et vérifier les
          seuils applicables à l&apos;activité mixte
        </Link>
        .
      </p>
      <p className="text-gray-700 leading-comfortable mb-4">
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        retient un seuil de <strong>15 000 €</strong> pour les meublés de tourisme non classés. Cela
        ne veut pas dire que tout meublé non classé est automatiquement exclu du régime micro : cela
      ...
      <ul className="space-y-2 mb-6 text-gray-700">
        <li className="flex gap-3">
          ...
          <span>
            si les seuils du micro ne sont plus respectés sur les années de référence, le régime
            réel devient la règle ;
          </span>
        </li>
        <li className="flex gap-3">
          <span className="text-primary-400 font-bold shrink-0 mt-0.5" aria-hidden="true">
      ...
      <div className="space-y-6 mb-8">
        {(
          [
            ...
            {
              num: '4',
              title: "S'il ne confond pas sa situation fiscale avec le régime micro-entrepreneur",
