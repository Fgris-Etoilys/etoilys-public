  ...
  return (
      ...
      lede={
        <>
          ...
          <p className="text-xl leading-comfortable text-gray-700 mb-10">
            ...
            dans certaines conditions, jusqu'à <strong>90 jours</strong>. L'enjeu pour vous est
            simple : ne pas confondre la règle nationale, les décisions locales, et les autres
            limites qui existent en location saisonnière. Cette règle concerne par ailleurs tous les
            meublés de tourisme, pas seulement ceux loués via Airbnb — Abritel, Booking ou la
            location en direct sont également visés.
          </p>
        </>
      }
      keyTakeaways={
    ...
    >
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        professionnelle, raison de santé ou cas de force majeure. C'est ce que prévoit l'
        <a
      ...
      <ul className="space-y-2 mb-6 text-gray-700">
        ...
        <li className="flex gap-3">
          ...
          <span>
            il faut <strong>vérifier la règle locale</strong> de la commune où se situe le bien.
          </span>
        </li>
      </ul>
      ...
      <p className="text-gray-700 leading-comfortable mb-4">
        ...
        a renforcé les outils de régulation locale des meublés de tourisme. Parmi ces outils figure
      ...
      <ul className="space-y-2 mb-6 text-gray-700">
        <li className="flex gap-3">
          ...
          <span>
            croire qu'une location de 20 nuits par an est interdite parce qu'on a vu "90 jours"
            quelque part ;
          </span>
        </li>
        <li className="flex gap-3">
          ...
          <span>
            croire à l'inverse qu'on peut louer 150 jours au total tant qu'aucun séjour ne dépasse
            90 jours ;
          </span>
        </li>
        <li className="flex gap-3">
          ...
          <span>
            ou croire qu'une commune passée à 90 jours fait automatiquement perdre au logement son
            statut de résidence principale dès le 91e jour.
          </span>
        </li>
      </ul>
      <p className="text-gray-700 leading-comfortable mb-4">
      ...
      <div className="space-y-4 mb-8">
        {(
          [
            ...
            {
              num: '2',
              title: "Ne pas oublier qu'au-delà d'un certain volume, d'autres questions se posent",
      ...
      <div className="space-y-4 mb-8">
        {(
          [
            ...
            {
              num: '3',
              title: "Quelle déclaration ou quel enregistrement s'applique depuis le 20 mai 2026 ?",
              desc: (
                <>
                  <p className="mb-3">
                    Depuis le 20 mai 2026, le Code du tourisme prévoit une déclaration soumise à
                    enregistrement via un téléservice national pour les meublés de tourisme. En
                    pratique, la DGE indique que le dispositif API Meublés est encore en phase de
                    transition : pendant la version bêta, les loueurs continuent à s'enregistrer
                    auprès de leur commune, puis la version finale prévue au second semestre 2026
                    doit permettre l'enregistrement national direct par les loueurs.
                  </p>
                  <p>
                    Avant de louer, vérifiez donc à la fois les consignes de votre commune et l'état
                    du déploiement du téléservice national. Cette démarche est distincte du plafond
                    de 120 jours ou du plafond local éventuellement abaissé.
                  </p>
                </>
              ),
            },
            {
              num: '4',
              title: 'La commune a-t-elle abaissé le plafond annuel en dessous de 120 jours ?',
