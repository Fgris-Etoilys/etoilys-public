        ...
        <div className="container-adaptive">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-primary-100 border-l-4 border-primary-300 rounded-card p-6 mb-12">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex gap-3">
                  ...
                  <span>
                    Jusqu&apos;ici, certains loueurs n&apos;étaient pas concernés par une
                    déclaration systématique, notamment lorsque le logement loué était leur{' '}
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    Avec API Meublés,{' '}
                    <strong>
                      tous les loueurs de meublés de tourisme devront demander ou redemander un
            ...
            <p className="text-gray-700 leading-comfortable mb-4">
              Le changement important n&apos;est pas seulement technique. Il ne s&apos;agit pas
              juste de remplacer un formulaire par un autre, avec un joli nom numérique pour faire
              moderne.
            </p>
            <p className="text-gray-700 leading-comfortable mb-4">
              Jusqu&apos;au 20 mai 2026, le Code du tourisme prévoyait une déclaration auprès du
              maire pour les meublés de tourisme, mais avec une exception importante : cette
              déclaration préalable n&apos;était pas obligatoire lorsque le logement constituait la{' '}
              <strong>résidence principale</strong> du loueur. Dans certaines communes, une
              procédure d&apos;enregistrement pouvait déjà s&apos;appliquer plus largement, mais ce
            ...
            <p className="text-gray-700 leading-comfortable mb-4">
              ...
              <strong>nouveau numéro d&apos;enregistrement national</strong> lorsque le téléservice
              final sera ouvert.
            </p>
            <div className="bg-gray-50 border border-gray-200 rounded-card p-5 mb-6">
              <p className="text-gray-700 leading-comfortable">
                La DGE est claire sur ce point : au lancement de la version finale d&apos;API
                Meublés, <strong>tous les loueurs, sans exception</strong>, devront demander un
                numéro d&apos;enregistrement auprès du téléservice national pour chaque meublé de
                tourisme mis en location.
              </p>
            </div>
            ...
            <p className="text-gray-700 leading-comfortable mb-4">
              <strong>API Meublés</strong> est la nouvelle plateforme nationale qui doit centraliser
              les données liées aux meublés de tourisme.
            </p>
            <p className="text-gray-700 leading-comfortable mb-4">
              Son objectif est simple à comprendre : aujourd&apos;hui, les informations sont
              dispersées entre les communes, les plateformes de location et les anciens systèmes
              d&apos;enregistrement locaux. Résultat : des démarches différentes selon les
              territoires, des numéros qui ne se ressemblent pas, des contrôles plus compliqués, et
              une belle usine à gaz administrative.
            </p>
            <p className="text-gray-700 leading-comfortable mb-4">
            ...
            <p className="text-gray-700 leading-comfortable mb-4">
              ...
              ouvert, il faudra passer par le téléservice national relié à API Meublés pour obtenir
              un <strong>numéro d&apos;enregistrement national</strong>.
            </p>
                ...
                <tbody>
                  <tr className="bg-white border-b border-gray-100">
                    ...
                    <td className="p-3 text-gray-600">
                      ...
                      Service-Public, par un formulaire ou par le service propre de certaines
                      mairies.
                    </td>
                  </tr>
                  ...
                  <tr className="bg-white">
                    ...
                    <td className="p-3 text-gray-600">
                      Le téléservice national relié à API Meublés doit permettre aux loueurs de
                      demander leur nouveau numéro d&apos;enregistrement national.
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <p className="text-gray-700 leading-comfortable mb-4">
              En pratique, cela veut dire que pendant la période intermédiaire, avant
              l&apos;ouverture du téléservice national API Meublés aux loueurs, il faudra suivre les
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-card p-5 mb-6">
              <p className="text-gray-700 leading-comfortable">
                Toutes les mairies ne fonctionneront pas forcément exactement de la même façon
                pendant cette transition. Certaines peuvent proposer leur propre service ou leurs
                propres modalités de dépôt. Il faut donc vérifier localement avant d&apos;envoyer un
                formulaire.
              </p>
            </div>
            ...
            <p className="text-gray-700 leading-comfortable mb-4">
              ...
              <strong>résidence principale</strong> du loueur. Si c&apos;est le cas, le texte
              prévoit que le loueur devra en apporter la preuve dans sa déclaration.
            </p>
            <p className="text-gray-700 leading-comfortable mb-4">
              La DGE indique aussi que des pièces justificatives seront nécessaires. La liste exacte
              est encore en cours de stabilisation, mais elle devrait notamment inclure :
            </p>
            <ul className="space-y-2 mb-6 text-gray-700">
              <li className="flex gap-3">
                <span className="text-primary-400 font-bold shrink-0 mt-0.5" aria-hidden="true">
              ...
              <li className="flex gap-3">
                ...
                <span>
                  un avis d&apos;imposition si le meublé est déclaré comme résidence principale du
                  loueur.
                </span>
              </li>
            </ul>
            <p className="text-gray-700 leading-comfortable mb-4">
              Une fois la déclaration complète reçue, le téléservice doit délivrer un avis de
              réception électronique avec un numéro de déclaration. Ce numéro servira ensuite de
              référence nationale pour identifier le meublé.
            </p>
            <p className="text-gray-700 leading-comfortable mb-4">
            ...
            <p className="text-gray-700 leading-comfortable mb-4">
              C&apos;est l&apos;une des questions les plus importantes pour les propriétaires qui
              ont déjà fait une déclaration dans leur commune.
            </p>
            <p className="text-gray-700 leading-comfortable mb-4">
            ...
            <p className="text-gray-700 leading-comfortable mb-4">
              ...
              loueurs devront demander un nouveau numéro d&apos;enregistrement national. Les loueurs
              déjà titulaires d&apos;un numéro délivré sous l&apos;ancienne législation
              bénéficieront d&apos;un <strong>délai raisonnable</strong> pour le renouveler.
            </p>
            <p className="text-gray-700 leading-comfortable mb-4">
              Après cette période transitoire, les anciens numéros deviendront invalides et ne
              pourront plus être utilisés auprès des intermédiaires de location.
            </p>
            <div className="bg-gray-50 border border-gray-200 rounded-card p-5 mb-6">
              <p className="text-gray-700 leading-comfortable">
                Si vous avez déjà un numéro local, il devra être remplacé par un nouveau numéro
                national lorsque le dispositif final sera ouvert.
              </p>
            </div>
            ...
            <p className="text-gray-700 leading-comfortable mb-4">
              ...
              <strong>amende administrative prononcée par la commune</strong>, dont le montant peut
              aller jusqu&apos;à <strong>10 000 €</strong>.
            </p>
            <p className="text-gray-700 leading-comfortable mb-4">
              Une fausse déclaration ou l&apos;utilisation d&apos;un faux numéro de déclaration peut
              entraîner une amende administrative pouvant aller jusqu&apos;à{' '}
              <strong>20 000 €</strong>.
            </p>
            <p className="text-gray-700 leading-comfortable mb-4">
              Avec API Meublés, l&apos;enregistrement devient un point central de conformité pour
              les loueurs de meublés de tourisme.
            </p>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-card p-5 mb-10">
              <p className="text-gray-700 leading-comfortable">
                Le changement à retenir est clair : l&apos;enregistrement des meublés de tourisme
                devient national, et tous les loueurs devront obtenir un nouveau numéro via API
                Meublés. Le service final n&apos;est pas encore ouvert aux propriétaires, mais la
                bascule est engagée.
              </p>
            </div>
