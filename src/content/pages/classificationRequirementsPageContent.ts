...
> = {
  ...
  nl: {
    hero: {
      ...
      description:
        'Classificatie is niet voorbehouden aan luxe woningen. Er zijn minimumcriteria, maar veel vakantiewoningen, juridisch aangeduid als “meublés de tourisme”, kunnen in de procedure passen wanneer zij schoon, functioneel, correct uitgerust en afgestemd op het maximaal aantal gasten zijn.',
    },
    eligibility: {
      title: 'Classificatie geldt voor meer woningen dan vaak wordt gedacht',
      paragraphs: [
        'Een vakantiewoning in deze juridische betekenis is een gemeubileerde volledige woning, verhuurd voor exclusief gebruik door de huurder, aan reizigers die er tijdelijk verblijven en er niet hun hoofdverblijf vestigen. Het kan gaan om een huis, appartement of studio.',
      ...
      highlight: {
        ...
        text: ' Voor een studio of eenkamerwoning voor 1 tot 2 personen begint de minimale basisoppervlakte bij 12 m² voor 1 ster. Voor een woning met één ruimte is de verplichte basisvoorwaarde 9 m² als de keuken apart is, of 12 m² met kitchenette.',
      },
    },
    criteria: {
      title: 'Punten om te controleren vóór een inspectiebezoek',
      description:
        'Voordat over sterren wordt gesproken, moet eerst worden nagegaan of de woning daadwerkelijk in de classificatieprocedure past. Het gaat niet alleen om voldoende uitrusting, maar ook om een woning die overeenkomt met de juridische definitie, de minimumvoorwaarden respecteert en een coherente capaciteit heeft.',
      items: [
        {
          title: 'Een echte vakantiewoning, geen uitgesloten accommodatievorm',
          paragraphs: [
            'Om te worden geclassificeerd, moet de woning een volledige, gemeubileerde woning zijn, verhuurd voor exclusief gebruik door de huurder, aan reizigers die er niet hun woonplaats vestigen.',
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Nog vóór de details van de beoordelingslijst moet de woning een gezonde basis tonen: een goede, aantoonbaar schone staat, werkende uitrusting, correcte sanitaire voorzieningen, een nette afwerking en geschikte bedden.',
          ],
        },
        {
          ...
          paragraphs: [
            ...
            'Een te kleine cabine, slaaphoek of ruimte zonder opening naar buiten wordt daarentegen niet beschouwd als echte verblijfsruimte voor de classificatie. Bedden in zulke ruimtes tellen niet mee voor het maximaal aantal gasten.',
          ],
        },
        {
          title: 'Een woning die voldoet aan minimale bewoonbaarheidsvoorwaarden',
          paragraphs: [
            'De woning moet voldoen aan een minimale basis van comfort en bewoonbaarheid. Concreet betekent dit onder meer dat zij een verblijfsruimte, een keuken of kitchenette in de woning, een badkamer of doucheruimte in de woning en sanitaire voorzieningen binnen moet hebben.',
      ...
      summary: {
        beforeStrong:
          'Kort gezegd moeten vóór het kiezen van een categorie vier punten worden gecontroleerd: dat de woning overeenkomt met de juridische definitie, dat zij aan minimale bewoonbaarheidsvoorwaarden voldoet, dat oppervlakte en maximaal aantal gasten coherent zijn, en dat zij wordt gepresenteerd in een ',
    ...
    blockingPoints: {
      ...
      items: [
        ...
        'het ontbreken van een verplichte basisvoorwaarde;',
    ...
    checklist: {
      ...
      items: [
        ...
        'nagaan of de uitrusting overeenkomt met het maximale aantal gasten;',
