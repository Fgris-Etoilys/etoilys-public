...
export const requestClassificationPageContent = {
  ...
  nl: {
    hero: {
      ...
      description:
        'Dien uw aanvraag in enkele minuten in voor een vakantiewoning in Frankrijk. Etoilys neemt binnen één werkdag contact met u op om de inspectievoorwaarden, het toepasselijke tarief en de eerstvolgende beschikbaarheden te bevestigen voordat u de aanvraag definitief bevestigt.',
