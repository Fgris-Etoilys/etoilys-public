...
export const BORDEAUX_LOCAL_LANDING_PAGE_V6: LocalLandingPageV6CityConfig = {
  ...
  expertise: {
    ...
    image: {
      ...
      alt: 'Jardin Public à Bordeaux',
      sizes: '(min-width: 900px) 35vw, 100vw',
      className: 'h-full w-full object-cover object-[center_48%]',
      caption: 'Jardin Public, Bordeaux.',
      credit: {
        sourceLabel: 'Marc Ryckaert (MJJR) / Wikimedia Commons',
        sourceHref: 'https://commons.wikimedia.org/wiki/File:Bordeaux_Jardin_Public_R02.jpg',
