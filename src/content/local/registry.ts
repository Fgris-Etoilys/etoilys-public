...
export const LOCAL_REGISTRY: LocalRegistryEntry[] = [
  ...
  },
  {
    ...
    departmentLabel: 'Lacanau et Médoc Atlantique',
    seo: {
      lastModified: '2026-09-19',
      title: 'Classement meublé de tourisme Lacanau & Médoc Atlantique | Etoilys',
      description:
      ...
      breadcrumbLabel: 'Lacanau et Médoc Atlantique',
      ogImageKey: 'medocAtlantiqueHero',
      lcpImageKey: 'medocAtlantiqueHero',
      lcpImageSizes: '(min-width: 1336px) 570px, (min-width: 900px) 45vw, 100vw',
    },
  },
  {
